...
===============
chinese:
这是一个插件框架，一个仿OSGI的框架 由egeyeaddin-1035 项目改编而来
特点：
1、功能service化，各个组件通过接口获取service ，获得相应的功能
2、支持 Web Application 和 Console （内含demo，理论上也支持 winform ）
3、组件必须实现Activator class 和 添加 Plugin.addin 配置文件
